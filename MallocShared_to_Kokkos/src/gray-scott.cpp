...
int main( int argc, char * argv[] ) {
    ...
    try {
        ...
        Kokkos::View<real*,Kokkos::SharedSpace> u1("u1",nb_rows_ext*nb_cols_ext);
        Kokkos::View<real*,Kokkos::SharedSpace> u2("u2",nb_rows_ext*nb_cols_ext);
        Kokkos::View<real*,Kokkos::SharedSpace> v1("v1",nb_rows_ext*nb_cols_ext);
        Kokkos::View<real*,Kokkos::SharedSpace> v2("v2",nb_rows_ext*nb_cols_ext);
        ...
        insert(nb_rows,nb_cols,u0,u1.data()) ;
        insert(nb_rows,nb_cols,v0,v1.data()) ;
        ...
        for ( std::size_t image = 0 ; image < nb_imgs ; ++image ) {
            ...
            extract(nb_rows,nb_cols,v1.data(),v0) ;
            result += std::reduce(v0.begin(),v0.end(),REAL0)*coef ;
            // HDF5 : write image
