    ...
    \begin{columns}
        \begin{column}{0.55\linewidth}
            \begin{minted}[breakafter={=}]{sh}
                cmake \
                    -B build/cuda \
                    -DCMAKE_INSTALL_PREFIX=${path_to_install}/cuda \
                    -DCMAKE_BUILD_TYPE=Release \
                    -DKokkos_ENABLE_CUDA=ON \
                    -DKokkos_ARCH_XXXX=ON
        ...
        \begin{column}{0.45\linewidth}
            \begin{itemize}
                ...
                \item Enable CUDA architecture XXXX
            \end{itemize}
        \end{column}
    \end{columns}
\end{exerciseframe}
        ...
        \begin{column}{0.55\linewidth}
            \begin{minted}[breakafter={=}]{sh}
                cmake \
                    -B build/cuda \
                    -DCMAKE_BUILD_TYPE=Release \
                    -DKokkos_ROOT=${path_to_install}/cuda
...
\begin{frame}{View with SharedSpace memory space}
    ...
    \begin{itemize}
        ...
        \item Convenient, but comes with a performance cost
    \end{itemize}
\end{frame}
        ...
        \begin{column}{0.5\linewidth}
            \begin{minted}[breakafter={=,/}, fontsize=\scriptsize]{C++}
                cmake \
                    -B build/cuda \
                    -DCMAKE_BUILD_TYPE=Release \
                    -DCMAKE_INSTALL_PREFIX=${path_to_install}/cuda/tools
                    -DKokkos_ROOT=${path_to_install}/cuda
                ...
                export PATH=${path_to_install}/cuda/tools/bin:$PATH
                export LD_LIBRARY_PIATH=${path_to_install}/cuda/tools/lib:$LD_LIBRARY_PATH
            \end{minted}
        \end{column}
        \begin{column}{0.5\linewidth}
            \begin{itemize}
