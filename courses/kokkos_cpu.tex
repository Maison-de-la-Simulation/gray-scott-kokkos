    ...
    \begin{columns}
        \begin{column}{0.55\linewidth}
            \begin{minted}[breakafter={=}]{sh}
                cmake \
                    -B build/serial \
                    -DCMAKE_INSTALL_PREFIX=${path_to_install}/serial \
                    -DCMAKE_BUILD_TYPE=Release
        ...
        \begin{column}{0.5\linewidth}
            \begin{minted}[breakafter={=}]{sh}
                cmake \
                    -B build/serial \
                    -DCMAKE_BUILD_TYPE=Release \
                    -DKokkos_ROOT=${path_to_install}/serial
    ...
    \begin{columns}
        ...
        \begin{column}{0.5\linewidth}
            \begin{itemize}
                ...
                \item Use Kokkos views instead of plain-old-data arrays for \texttt{u} and \texttt{v} in \texttt{main} and in \texttt{compute}
                \item For now, just pass a raw pointer when calling \texttt{print\_checksum} and \texttt{print\_field}
...
\begin{exerciseframe}{From your worktree}
    \begin{columns}
        ...
        \begin{column}{0.5\linewidth}
            \begin{itemize}
                \item Use Kokkos \texttt{parallel\_for} and \texttt{MDRangePolicy} instead of the nested loops in \texttt{compute}
                \item The checksum must remain the same!
            \end{itemize}
        \end{column}
    \end{columns}
...
\begin{exerciseframe}{From your worktree}
    \begin{columns}
        ...
        \begin{column}{0.5\linewidth}
            \begin{itemize}
                \item Use Kokkos \texttt{parallel\_reduce} and \texttt{MDRangePolicy} instead of the nested loops in \texttt{print\_checksum}
                \item The checksum must remain the same!
            \end{itemize}
        \end{column}
    \end{columns}
        ...
        \begin{column}{0.55\linewidth}
            \begin{minted}[breakafter={=}]{sh}
                cmake -B build/openmp \
                    -DCMAKE_INSTALL_PREFIX=${path_to_install}/openmp \
                    -DCMAKE_BUILD_TYPE=Release \
                    -DKokkos_ENABLE_OPENMP=ON \
        ...
        \begin{column}{0.5\linewidth}
            \begin{minted}[breakafter={=}]{sh}
                cmake \
                    -B build/openmp \
                    -DCMAKE_BUILD_TYPE=Release \
                    -DKokkos_ROOT=${path_to_install}/openmp
...
\begin{exerciseframe}{From your worktree or the cpu folder}
    \begin{itemize}
        \item Perform a strong scaling
        \item Perform a weak scaling
    \end{itemize}
\end{exerciseframe}
...
\begin{frame}{Conclusion}
    ...
    \begin{alertblock}{Caution}
        The Kokkos code so far only works on CPU and is not portable!
    \end{alertblock}
\end{frame}
